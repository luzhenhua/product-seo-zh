...
Competitor brief input: review the "Applications" lists competitors use. If competitors all
list the same 5-6 generic industries, INCLUDE 1-2 specific scenarios competitors missed
(e.g., "asphalt millings recycling for road resurfacing" vs. generic "recycling"; "marble
sludge dewatering" vs. generic "non-metallic minerals"). Drop or de-emphasize industries
that are obvious filler.
