...
Competitor brief input: avoid the boilerplate definition all competitors use; if Differentiation
Lock includes a domain angle (e.g., wet-feed / energy / maintenance), weave one phrase into
Paragraph 1 or 2 so the definition reads page-specific, not interchangeable with competitors'.
