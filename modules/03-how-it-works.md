...
Competitor brief input: if all competitors describe the principle in the same neutral way,
add ONE differentiated angle from the Differentiation Lock (e.g., "how this principle handles
wet/sticky feed" / "why this mechanism reduces energy vs. comparable equipment") in Paragraph 1
or Paragraph 3 — without distorting the core mechanism description.
